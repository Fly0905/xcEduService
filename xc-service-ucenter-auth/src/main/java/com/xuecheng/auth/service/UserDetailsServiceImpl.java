...
//        userext.setPermissions(new ArrayList<>()); //TOD O权限先用静态的
...
//       String password ="123";
        ...
        if(permissions == null){
            permissions = new ArrayList<>(); // 防止空指针异常
        }
        List<String> user_permission = new ArrayList<>();
        permissions.forEach(item -> user_permission.add(item.getCode()));

        // 使用静态的权限表示用户所拥有的权限
//        user_permission.add("course_get_baseinfo"); //查询课程信息的权限
//        user_permission.add("course_find_pic");   //图片查询的权限

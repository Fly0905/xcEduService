...
//        command.add("D:/software/ffmpeg-20180227-fa0c9d6-win64-static/bin/ffmpeg.exe");
        ...
        command.add("-i");
        command.add("D:/Program Files/ffmpeg_test/1.avi");
        ...
        command.add("-r");
        command.add("18");
        command.add("D:/Program Files/ffmpeg_test/1.mp4");
    ...
    public void testProcessMp4() {
        ...
        //video_path视频地址
        String video_path = "D:/Program Files/ffmpeg_test/1.avi";
        //mp4_name mp4文件名称
        String mp4_name = "1.mp4";
        //mp4folder_path mp4文件目录路径
        String mp4folder_path = "D:/Program Files/ffmpeg_test/";

...
public enum MediaCode implements ResultCode {
    ...
    UPLOAD_FILE_REGISTER_CREATEFOLDER_FAIL(false,22006, "上传文件注册创建文件夹失败!"),
    UPLOAD_FILE_REGISTER_ISNULL(false, 22007, "上传文件注册的时候是空!"),
    CHUNK_FILE_UPLOAD_FAIL(false, 22008, "上传文件失败!");
